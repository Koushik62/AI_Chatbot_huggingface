...
class OrderTakingAgent():
    ...
    def get_response(self, messages):
        ...
        asked_recommedation_before = False
        for message_index in range(len(messages)-1, 0, -1):
            ...
            if message["role"] == "assistant" and agent_name == "order_taking_agent":
                ...
                asked_recommedation_before = message["memory"]["asked_recommendation_before"]
        ...
        output = self.postprocess(chatbot_output, messages, asked_recommedation_before)
